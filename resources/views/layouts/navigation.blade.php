            ...
            <div class="flex gap-4 items-center justify-end">
                ...
                <div class="hidden lg:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="cursor-pointer inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-base-content bg-base-200 hover:text-base-content focus:outline-hidden transition ease-in-out duration-150">
